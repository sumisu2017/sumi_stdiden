...
//---模組基本資訊---//
$modversion['name']        = _MI_SUMISTDIDEN_NAME;
$modversion['version']     = '1.0';
$modversion['description'] = _MI_SUMISTDIDEN_DESC;
$modversion['author']      = _MI_SUMISTDIDEN_AUTHOR;
$modversion['credits']     = _MI_SUMISTDIDEN_CREDITS;
$modversion['help']        = 'page=help';
$modversion['license']     = 'GPL see LICENSE';
$modversion['license_url'] = 'www.gnu.org/licenses/gpl-2.0.html/';
$modversion['image']       = "images/logo1.png";
$modversion['dirname']     = basename(dirname(__FILE__));
//$modversion['dirname']     = basename(__DIR__);

//---模組狀態資訊---//
$modversion['status_version']      = '1.0';
$modversion['release_date']        = '2020-07-31';
$modversion['module_website_url']  = 'https://github.com/sumi/';
$modversion['module_website_name'] = _MI_SUMISTDIDEN_AUTHOR_WEB;
$modversion['module_status']       = 'release';
$modversion['author_website_url']  = 'https://github.com/sumi/';
$modversion['author_website_name'] = _MI_SUMISTDIDEN_AUTHOR_WEB;
...
$modversion['paypal']['business']      = 'sumisu@tn.edu.tw';
...
$modversion['tables'][0]        = 'sumi_stdkind';
$modversion['tables'][1]        = 'sumi_stdkindfee';
$modversion['tables'][2]        = 'sumi_stdiden';
...
$i                                          = 1;
$modversion['templates'][$i]['file']        = 'sumistdiden_admin.tpl';
$modversion['templates'][$i]['description'] = '後台管理頁樣板';

$i++;
$modversion['templates'][$i]['file']        = 'sumistdiden_index.tpl';
$modversion['templates'][$i]['description'] = '前台樣板';
